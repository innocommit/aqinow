...
import type { LoginData, LoginResponse, LoginError, GetAllUsersData, GetAllUsersResponse, GetAllUsersError, CreateUserData, CreateUserResponse, CreateUserError, DeleteUserData, DeleteUserResponse, DeleteUserError } from './types.gen';
import { client as _heyApiClient } from './client.gen';
import { getAllUsersResponseTransformer } from './transformers.gen';
...
export const getAllUsers = <ThrowOnError extends boolean = false>(options?: Options<GetAllUsersData, ThrowOnError>) => {
    return (options?.client ?? _heyApiClient).get<GetAllUsersResponse, GetAllUsersError, ThrowOnError>({
